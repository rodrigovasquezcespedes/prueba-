...
const ProductCrud = () => {
  ...
  const [editingProduct, setEditingProduct] = useState(null) // Nuevo estado para edición
  const [newProduct, setNewProduct] = useState({
    ...
    description: '',
    stock: '',
    image_url: '', // Agregado campo de URL de la imagen
    specifications: []
  })
  ...
  const fetchProducts = async () => {
    try {
      ...
      console.log('Productos obtenidos desde la API:', response.data)
  ...
  // Editar un producto (establecer el producto a editar en el formulario)
